...
<div class="container" style="background-color:#f4f3ef;">
			...
			<div class="col-md-8">
				<div class="card">
					<div class="card-body">
						...
						<br>
						<button id="submit_exam" class="btn btn-primary">Submit Exam</button>
					</div>
				</div>
				<br />
	...
	<script>
		$(document).on('click', '#submit_exam', function () {
			var examId = $('#processExamId').data('exam_id');
			if (confirm("Are you sure you want to submit the exam?")) {
				$.ajax({
					...
					success: function (response) {
						...
						if (data.success) {
							console.log("Your exam has been submitted successfully!");
							window.location.reload();
						} else {
							console.log("Failed to submit the exam.");
						}
					}
				});
			}
